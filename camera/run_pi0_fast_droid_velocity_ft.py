...
CHECKPOINT_DIR = "ścieżka_do_folderu_499" # < ----------------------------------------------
...
def vision_loop():
    ...
    print("[Brain] Loading local fine-tuned Pi0 Droid model...")
    # try:
    pi0_config = _config.get_config("pi05_droid_finetune")
    print("[Brain] Using config: pi05_droid_finetune")
    # except Exception as e:
    #     print(f"[Brain] Could not load pi05_droid_finetune ({e}). Falling back to pi05_droid.")
    #     pi0_config = _config.get_config("pi05_droid")
    #     print("[Brain] Using config: pi05_droid")
    ...
    try:
        while is_running:
            ...
            example = {
                ...
                # pi05_droid_finetune expects two exterior streams; duplicate if only one camera is available.
                "observation/exterior_image_2_left": image_ext_rgb,
